...
HELP_TEXT = (
    ...
    "   Бот пришлёт .conf файл и QR-код в этот чат.\n\n"
    ...
    "5. Раздельное туннелирование?\n"
    "   После настройки VPN бот пришлёт amnezia_sites.json.\n"
    "   Повторно: меню «🎁 Туннелирование» или /my.\n\n"
